if type -q 'fd'
	...
	set -q FZF_CD_COMMAND; or set -Ux FZF_CD_COMMAND "fd -Lt d $exclude"
	set -q FZF_CD_WITH_HIDDEN_COMMAND; or set -Ux FZF_CD_WITH_HIDDEN_COMMAND "fd -Lt d --hidden $exclude"
end
